...
class CatalogService {
  ...
  /// Descarga el catálogo del día para la empresa autenticada.
  ///
  /// El backend filtra por `empresa_id` del token. NO se envía
  /// `empresa_id` desde el cliente.
  ///
  /// La base diaria se purga antes de insertar para garantizar
  /// que no queden productos de una empresa anterior.
