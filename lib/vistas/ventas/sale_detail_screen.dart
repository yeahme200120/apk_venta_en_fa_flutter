...
class _SaleDetailScreenState
  ...
  Future<void> _loadCashOperations() async {
    ...
    try {
      final operations =
          await _apiClient.getCashOperations();
      ...
      debugPrint(
        '[CAJA] Error cargando movimientos: $error',
      );
  ...
  Future<void>
      _syncPendingSalesAndCatalog() async {
